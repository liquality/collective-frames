...
export async function GET(request: NextRequest, response: NextResponse) {
  ...
  const nft = await create1155Contract(
    "0x49CF4E6D8D86738742DDF41D5D153C698AecF0Ad",
    "0xeFc58E332287066Af77c291Fca8E636D0925a501",
    {
      name: "My Collective NFT 14", // Must be unique for each deploy, else contract fails with createDeterministicContractError on Zora
      pricePerMintETH: "0.0000",
      ...
      paymentCurrency: "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE",//"0xAC1Bd2486aAf3B5C0fc3Fd868558b082a531B2B4"// "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913",
    }
  )
